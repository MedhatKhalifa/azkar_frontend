...
import 'package:wazker/pages/AzkarListPage.dart';
import 'dart:convert';
...
class AzkarController extends GetxController {
    ...
    try {
      ...
      if (dbVersion.value != newVersion) {
        ...
        await prefs.setString(
          'cached_azkar',
          json.encode(
            azkarList.map((azkar) => azkar.toJson()).toList(),
          ),
        );
  ...
  void filterAzkarByLanguage() {
    ...
    uniqueSubCategories.value = filteredAzkar
        ...
        .toSet()
        .where((subCategory) => subCategory.isNotEmpty) // Remove empty values
        .toList();
  ...
  void performSearch2(String query) {
    ...
    Set<String> seenContent = Set<String>();
